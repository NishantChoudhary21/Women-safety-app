...
public class FragmentDashBoardBindingImpl extends FragmentDashBoardBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.guardianButton, 4);
        sViewsWithIds.put(R.id.imageView, 5);
        sViewsWithIds.put(R.id.vie, 6);
        sViewsWithIds.put(R.id.locButton, 7);
        sViewsWithIds.put(R.id.imageView1, 8);
        sViewsWithIds.put(R.id.vie1, 9);
        sViewsWithIds.put(R.id.emerButton, 10);
    }
    // views
    @NonNull
